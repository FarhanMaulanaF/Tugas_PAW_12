  ...
  if (!errors.isEmpty()) {
    ...
    User.findOne(
      ...
      (err, user) => {
        ...
        const message = ` <p>Hai, ${name} </p>
        <p> Anda telah melakukan permintaan untuk reset password akun Money Tracker App.</p>
    ...
    if (resetPasswordLink) {
      jwt.verify(
        ...
        function (err, decoded) {
          ...
          User.findOne(
            //Mengecek hasil assign resetPassword link pada register controllerac
            {
              resetPasswordLink,
            },
            (err, user) => {
