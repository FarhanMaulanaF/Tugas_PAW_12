    ...
    <div id="section-2" name='features' className="bg-white h-screen md:py-32 flex flex-col font-Roboto">
      <div className="flex flex-col h-fit md:h-screen mx-auto">
        ...
        <div className='md:flex flex-row items-center text-center gap-6 md:gap-5 h-4/5 mt-10 md:mt-20 font-medium'>
          <div className='h-full my-2 flex flex-col w-11/12 bg-[#319C69] flex items-center rounded-lg'>
            <div className="m-10">
          ...
          <div className='h-full my-2 mx-auto flex flex-col w-11/12 bg-[#319C69] flex items-center rounded-lg'>
            <div className='mt-10'>
              <img src={Savingmoney} alt="Saving Money Illustration"/>
            </div>
            <p className="mx-auto w-3/5 text-[#FFFFFF] mt-10">
              Visualize your income and expenses based on your own categories
            </p>
          </div>
          <div className='h-full my-2 mx-auto flex flex-col w-11/12 bg-[#319C69] flex items-center'>
            <div className='m-10'>
