...
function AboutUs() {
  return (
    <div id="section-3" name='aboutus' className='bg-white pt-48 font-Roboto h-screen w-screen flex '>
      <div className='flex mt-16 sm:mt-0 md:flex-row flex-col gap-5 w-[95%] h-1/2'>
        ...
        <div className='text-black text-center font-black text-4xl justify-center'>Meet our Team</div>
