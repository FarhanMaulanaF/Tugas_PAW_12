    ...
    >
      <div className="md:grid-cols-2 grid mt-16 sm:mt-0 md:flex-row flex-col gap-5 w-fit h-1/2">
        <div className="justify-center md:ml-16">
          <div className="text-black text-center font-black text-2xl xm:text-4xl content-center md:text-left">
            About Us
          </div>
          <div className="text-black text-justify text-sm xm:text-xl font-light my-5 w-2/3 mx-auto md:mx-0 md:w-4/6 md:text-left">
          ...
          <div className="flex justify-center md:justify-start">
            <Link to="/register">
              <button class="bg-[#319C69] text-white md:text-left font-medium py-3 px-7 rounded-lg my-5 xm:my-16 text-sm xm:text-xl hover:bg-[#263238] hover:text-white">
                Get Started
              </button>
            </Link>
          </div>
        ...
        <div className="">
          <div className="flex flex-col pt-10 md:pt-0 justify-center">
            <div className="flex justify-center text-black text-center font-black text-2xl xm:text-4xl">
              Meet our Team
            </div>
